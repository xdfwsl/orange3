...
本项目是 [Orange3](https://github.com/biolab/orange3) 的**完整中文汉化版本**，由**河北科技工程职业技术大学 李洪燕**维护，基于 Orange3 上游主线开发，提供开箱即用的中文界面。

Orange 是一款面向初学者和专家的数据挖掘与可视化工具箱。使用 Orange 探索数据**无需编程或深入的数学知识**。通过基于工作流的拖拽式操作，任何拥有数据或对数据感兴趣的人都可以轻松上手。本中文版特别适合国内高校数据科学、机器学习相关课程的教学使用。
...
1. 前往 [Releases](https://github.com/xdfwsl/orange3/releases) 页面下载最新的 **Orange3-中文版.exe** 安装包
2. 双击运行安装程序，按提示完成安装
3. 从桌面快捷方式或开始菜单启动 Orange3 中文版

> 如果 Releases 页面尚未提供安装包，可先使用下方 pip 或 conda 方式安装。
...
本项目旨在为国内高校师生提供一个易于使用的中文数据挖掘教学平台。如果您在教学或科研中使用了本项目，欢迎通过 [Issues](https://github.com/xdfwsl/orange3/issues) 反馈使用体验和改进建议。
...
- [Claude](https://claude.ai/) — Anthropic 开发的 AI 助手，协助完成大部分翻译工作
